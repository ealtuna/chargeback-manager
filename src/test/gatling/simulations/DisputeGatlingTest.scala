...
/**
 * Performance test for the Dispute entity.
 */
class DisputeGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Dispute entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created dispute")
                .get("${new_dispute_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created dispute")
            .delete("${new_dispute_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
